        ...
        return (
          <div className="App">
            ...
            <div className="App-intro">
                <br />
                <button onClick={ this.toggleDiv }>Toggle Profile</button>
                <br /><br />
                { this.state.show && <Box /> }
            </div>
          </div>
